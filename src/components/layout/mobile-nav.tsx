...
export function MobileNav() {
  ...
  const items = [["/discover", Compass, "Discover"], ["/frequencies", Radio, "Frequencies"], ["/vibe", Headphones, "Vibe"], ["/signals/new", Plus, "New"], ["/archive", Archive, "Archive"], [`/profile/${session?.user?.username || "hela"}`, UserRound, "Profile"]] as const;
