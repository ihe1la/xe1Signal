...
const signalSeeds = [
  ...
  {
    id: "sample-ihe1la-audius-night",
    type: "SONG",
    title: "The Night",
    description:
      "A native Audius stream sample — no embed, just the persistent Signal player.",
    sourceUrl: "https://audius.co/cromaluce/the-night",
    sourceDomain: "audius.co",
    mediaProvider: "audius",
    mediaEntityType: "track",
    externalId: "2ANlJpp",
    providerUri: null,
    creatorName: "CROMALUCE",
    thumbnailUrl:
      "https://val005.open-audio-validator.com/content/01JYPAW18SPGDFT3QMN3Z5J3JR/480x480.jpg",
    previewImageUrl:
      "https://val005.open-audio-validator.com/content/01JYPAW18SPGDFT3QMN3Z5J3JR/480x480.jpg",
    durationMs: 140000,
    tags: "audius,electronic,brooding,night",
    frequencyId: "sample-ihe1la-songs-that-hurt",
  },
  {
    id: "sample-ihe1la-tokyo",
    type: "IMAGE",
    title: "Tokyo textures",
    description: "Concrete curves, shadows, and quiet geometry.",
    previewImageUrl:
      "https://images.unsplash.com/photo-1519501025264-65ba15a82390?auto=format&fit=crop&w=1200&q=80",
    sourceUrl: "https://unsplash.com/photos/city-buildings",
    sourceDomain: "unsplash.com",
    tags: "tokyo,architecture,shadow",
    frequencyId: "sample-ihe1la-beautiful-interfaces",
  },
  {
    id: "sample-ihe1la-noticing",
    type: "LINK",
    title: "The Art of Noticing",
    description:
      "Relearning how to pay attention before the feed decides for you.",
    sourceUrl: "https://robwalker.substack.com/",
    sourceDomain: "robwalker.substack.com",
    previewImageUrl:
      "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=80",
    tags: "attention,noticing,web",
    frequencyId: "sample-ihe1la-late-night",
  },
  {
    id: "sample-ihe1la-oauth-note",
    type: "NOTE",
    title: "OAuth is just trust with better formatting.",
    description: "A note from the middle of a broken login flow.",
    content:
      "The redirect is rarely the bug. The state you carry through it usually is.",
    tags: "oauth,trust,notes",
  ...
  {
    id: "sample-ihe1la-login-screen",
    type: "SCREENSHOT",
    title: "Clean login flow",
    description: "One decision per screen. No visual noise.",
    previewImageUrl:
      "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80",
    tags: "login,ui,screenshot",
    frequencyId: "sample-ihe1la-beautiful-interfaces",
  },
  {
    id: "sample-ihe1la-seoul",
    type: "IMAGE",
    title: "Seoul after rain",
    description: "Violet reflections and a city refusing to sleep.",
    previewImageUrl:
      "https://images.unsplash.com/photo-1519608487953-e999c86e7455?auto=format&fit=crop&w=1200&q=80",
    sourceUrl: "https://unsplash.com/",
    sourceDomain: "unsplash.com",
    tags: "seoul,rain,neon",
    frequencyId: "sample-ihe1la-late-night",
  },
  {
    id: "sample-ihe1la-voice",
    type: "AUDIO",
    title: "idea at 3am",
    description: "What if archives remembered the path between fragments?",
    content:
      "A quiet voice memo placeholder for the thought that arrived too late.",
    tags: "voice,3am,idea",
    frequencyId: "sample-ihe1la-late-night",
  },
  {
    id: "sample-ihe1la-document",
    type: "DOCUMENT",
    title: "Private archive field notes",
    description:
      "A small document about attention, memory, and keeping only what matters.",
    content:
      "Signal Archive field notes\n\nKeep the fragments that change how you see the next one.",
    tags: "document,archive,field notes",
    frequencyId: "sample-ihe1la-late-night",
  },
] as const;
...
async function main() {
  ...
  await db.researchTrail.upsert({
    ...
    create: {
      ...
      description: "From BLUE to the idea that arrived at 3am.",
      visibility: "PRIVATE",
      nodeCount: 4,
    },
    update: {
  ...
  const nodes = await Promise.all(
    [
      ...
      [
        "sample-ihe1la-seoul",
        "Seoul after rain",
        "The same blue, reflected outside.",
      ],
      [
        "sample-ihe1la-oauth-note",
        "Trust and redirects",
        "A technical interruption.",
      ],
      ["sample-ihe1la-voice", "idea at 3am", "The archive remembers the path."],
    ].map(([signalId, title, content], order) =>
      db.researchTrailNode.create({
        data: {
          trailId,
          signalId,
          type: "SIGNAL",
          ...
          content,
          order,
          positionX: 70 + order * 180,
          positionY: order % 2 ? 220 : 80,
        },
      }),
    ),
  );
  for (let index = 0; index < nodes.length - 1; index += 1) {
    await db.researchTrailConnection.create({
      data: {
        trailId,
  ...
  console.log(
    `Seeded ${signalSeeds.length} signals, ${frequencySeeds.length} frequencies, and 1 trail for @${ownerUsername}.`,
  );
}
